...
import com.rabbitframework.commons.utils.ReflectUtils;
...
public class SQLParser {
    ...
    public SQLParser(Method method, String sqlValueSrc, SqlCommendType sqlCommendType, Class<?> paramType,
        ...
        /**只有在修改、查询、删除时可以使用{@link WhereParamType} 做为参数传递，
         * 这里不做条限制,业务上在插入数据的时候不应该存在此参数的传递,哈哈
         **/
    ...
    private String getSearchSql() {
        return "<where>" +
                ...
                "#{listItem}" + "</foreach>" + "</when>" + "</choose>" +
                "</foreach>" + "</trim>" + "</if>" + "</foreach>" + "</where>";
    }
