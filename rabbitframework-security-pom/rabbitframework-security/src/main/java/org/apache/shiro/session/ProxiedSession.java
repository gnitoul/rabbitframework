...
/**
 * Simple <code>Session</code> implementation that immediately delegates all
 ...
 * <code>Session</code> calls and perform additional logic.
 *
 * @since 0.9
 */
public class ProxiedSession implements Session {
	...
	/**
	 * Constructs an instance that proxies the specified <code>target</code>.
	 * Subclasses may access this target via the
	 * <code>protected final 'delegate'</code> attribute, i.e.
	 * <code>this.delegate</code>.
	 *
	 * @param target
	 *            the specified target <code>Session</code> to proxy.
	 */
